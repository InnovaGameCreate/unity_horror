...
abstract public class SavableSingleton<T> where T : SavableSingleton<T>, new()
{
    ...
    public static string folderPath = Application.dataPath + "/Database/";//Application.persistentDataPath + "/Database/";
    public static string filePath = folderPath + typeof(T).FullName + "data.json";
